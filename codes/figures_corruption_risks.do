...
graph export "contract_cri.jpg", as(jpg) name("Graph") quality(100)
...
graph export "awarded_skopje_perc.png", as(png) replace
...
forvalues i = 1/8 {
    ...
    graph export "annex_reg_`i'.png", as(jpg) name("Graph") quality(100) replace
}
...
graph export "annex_ind_1.png", as(jpg) name("Graph") quality(100) replace

graph combine "g10" "g11" "g12" "g13" "g14" "g15" "g16" "g17" "g18", ///
        rows(3) graphregion(color(white)) iscale(.5) title("`text'", size(small))
graph export "annex_ind_2.png", as(jpg) name("Graph") quality(100) replace


graph combine "g19" "g20" "g21" "g22" "g23" "g24" "g25" "g26" "g27", ///
        rows(3) graphregion(color(white)) iscale(.5) title("`text'", size(small))
graph export "annex_ind_3.png", as(jpg) name("Graph") quality(100) replace


graph combine "g28" "g29"  "g30" "g31" "g32" "g33" "g34" "g35" "g36", ///
        rows(3) graphregion(color(white)) iscale(.5) title("`text'", size(small))
graph export "annex_ind_4.png", as(jpg) name("Graph") quality(100) replace

graph combine "g38" "g38" "g39"  "g40" "g41" "g42" "g43" "g44" "g45", ///
        rows(3) graphregion(color(white)) iscale(.5) title("`text'", size(small))
graph export "annex_ind_5.png", as(jpg) name("Graph") quality(100) replace
